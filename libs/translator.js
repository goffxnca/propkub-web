const TRANSLATIONS = {
  ...
  'This account was registered with Google':
    'บัญชีนี้ลงทะเบียนด้วย Google กรุณาใช้ปุ่ม "ล็อกอินด้วย Google" เพื่อเข้าสู่ระบบ',
  'This account was registered with Facebook':
    'บัญชีนี้ลงทะเบียนด้วย Facebook กรุณาใช้ปุ่ม "ล็อกอินด้วย Facebook" เพื่อเข้าสู่ระบบ',
  ...
  'Password has been updated successfully':
    'รหัสผ่านได้รับการอัปเดตเรียบร้อยแล้ว',
  ...
  'currentPassword must be longer than or equal to 6 characters':
    'รหัสผ่านปัจจุบันต้องมีความยาวอย่างน้อย 6 ตัวอักษร',
  'newPassword must be longer than or equal to 6 characters':
    'รหัสผ่านใหม่ต้องมีความยาวอย่างน้อย 6 ตัวอักษร22'
};
