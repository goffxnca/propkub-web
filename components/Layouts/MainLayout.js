...
const MainLayout = (props) => {
  ...
  return (
    <div>
      ...
      <Banner
        message={
          "PropKub ขอความร่วมมือผู้ลงประกาศต่างๆ ไม่ลงประกาศที่เป็นทรัพย์เดียวกันซ้ำซ้อนหลายๆครั้ง เนื่องจากส่งผลกระทบทางลบต่อเว็บไซต์ในการจัดอันอันดับบน Google โดยเรากำลังเร่งพัฒนาระบบดันประกาศขึ้นหน้าแรกให้ท่านใช้งานได้ฟรี โดยจะแล้วเสร็จในเร็วๆนี้"
        }
      />
